...
// Development / no-CMS fallback data (ADVOCATE_PORTFOLIO_PLAN §21).

export const dummyCases: CaseResult[] = [
  {
    _id: "1",
  ...
  {
    _id: "2",
    titleEn: "FIR Quashed Under Section 482 CrPC — Property Dispute Matter",
...
export const dummyAbout: AboutData = {
      ...
      children: [
        {
          _type: "span",
          _key: "s1",
          text: "Shreyansh Rai is a Criminal Law Advocate based in Lucknow, practising at the High Court of Judicature at Allahabad and the Lucknow Bench. With a BA.LLB (Hons.) and a specialised LLM in Criminal & Security Law, he brings a rigorous academic foundation to every matter he handles.",
          marks: [],
        },
      ],
    },
      ...
      children: [
        {
          _type: "span",
          _key: "s2",
          text: "His practice is built on meticulous preparation, a deep command of criminal procedure, and an unwavering commitment to every client's right to a fair defence — from bail and FIR quashing to full trial representation and appeals.",
          marks: [],
        },
      ],
    },
      ...
      children: [
        {
          _type: "span",
          _key: "hs1",
          text: "श्रेयांश राय लखनऊ स्थित एक आपराधिक विधि अधिवक्ता हैं, जो उच्च न्यायालय इलाहाबाद एवं लखनऊ खंडपीठ में अभ्यास करते हैं। बी.ए.एल.एल.बी (ऑनर्स) और आपराधिक एवं सुरक्षा विधि में विशेष एल.एल.एम के साथ, वे हर मामले में एक कठोर शैक्षणिक आधार लाते हैं।",
          marks: [],
        },
      ],
    },
...
export const dummyContact: ContactData = {
